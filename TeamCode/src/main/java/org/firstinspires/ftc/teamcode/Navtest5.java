...
@TeleOp(name = "navtest5")
public class Navtest5 extends LinearOpMode {
   ...
   // private Servo collectorTiltS;
    private DcMotor collectorTiltM;
    ...
    private void Initialize_Motors_Servos() {
        ...
        collectorTiltM.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
        //LRear.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
        ...
        tiltM.setPower(0.4);
        collectorTiltM.setDirection(DcMotorSimple.Direction.FORWARD);
        //tiltM.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
        collectorTiltM.setTargetPosition(tiltM.getCurrentPosition());
        collectorTiltM.setMode(DcMotor.RunMode.RUN_TO_POSITION);
        collectorTiltM.setPower(0.4);
    ...
    public void runOpMode() {
        ...
        collectorTiltM = hardwareMap.get(DcMotor.class, "collectorTiltM");
       ...
       // collectorTiltS = hardwareMap.get(Servo.class, "collectorTiltS");
        ...
        if (opModeIsActive()) {
            ...
            while (opModeIsActive()) {
                ...
                telemetry.addData("turntable", armRotationM.getCurrentPosition());
                telemetry.addData("tilt", tiltM.getCurrentPosition());
                telemetry.addData("collectorTilt", collectorTiltM.getCurrentPosition());
                telemetry.addData("extend", liftM.getCurrentPosition());
